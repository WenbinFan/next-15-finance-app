...
export default function TransactionItem({
    ...
    const typesMap = {
        'Income': {
            icon: HandCoins,
            colors: 'text-green-500 darkk:text-green-400'
        },
        'Expense': {
            icon: Wallet,
            colors: 'text-red-500 darkk:text-red-400'
        },
        'Saving': {
            icon: PiggyBank,
            colors: 'text-green-500 darkk:text-indigo-400'
        },
        'Investment': {
            icon: Landmark,
            colors: 'text-yellow-500 darkk:text-yellow-400'
        },
    }
